...
function checkComponentNameIsValid(name) {
  ...
  check(!!ccc[name], "The coelement of the given name is not registered: ".concat(name));
}
...
var _get = (function (name, el) {
  ...
  check(coelement, "no coelement named: ".concat(name, ", on the dom: ").concat(el.tagName));
  return coelement;
});
...
var on = (function (event) {
  ...
  return function (descriptor) {
    ...
    descriptor.finisher = function (constructor) {
      check(!!event, "Empty event handler is given: constructor=".concat(constructor.name, " key=").concat(key));
      /**
       * @param el The element
...
var emits = function emits(event) {
  return function (descriptor) {
    ...
    descriptor.finisher = function (constructor) {
      check(!!event, "Unable to emits an empty event: constructor=".concat(constructor.name, " key=").concat(key));
    };
  ...
  return function (descriptor) {
    ...
    descriptor.finisher = function (constructor) {
      Object.defineProperty(constructor.prototype, key, {
        get: function get() {
          check(!!this.el, "Component's element is not ready. Probably wired getter called at constructor.(class=[".concat(this.constructor.name, "]"));
          ...
          check(nodes.length > 0, "wired component \"".concat(name, "\" is not available at ").concat(this.el.tagName, "(class=[").concat(this.constructor.name, "]"));
...
var notifies = (function (event, selector) {
  return function (descriptor) {
    ...
    descriptor.finisher = function (constructor) {
      check(!!event, "Unable to notify empty event: constructor=".concat(constructor.name, " key=").concat(key));
    };
...
},{"./dist/capsid-cjs":2,"./dist/capsid-cjs.development":1,"_process":8}],4:[function(require,module,exports){
"use strict";
...
},{"path-to-regexp":7}],6:[function(require,module,exports){
"use strict";
...
},{"../const":16,"capsid":3}],10:[function(require,module,exports){
"use strict";
  ...
  return {
    ...
    d: [{
      ...
      value: function value(_ref) {
        ...
        this.todoCountLabel.innerHTML = "<strong>".concat(countLeft, " item").concat(countLeft === 1 ? '' : 's', " left</strong>");
...
},{"../const":16,"../domain":18,"capsid":3}],11:[function(require,module,exports){
"use strict";
...
},{"./edit":9,"./footer":10,"./main":12,"./new-todo":13,"./todo-item":14,"./todo-list":15}],12:[function(require,module,exports){
"use strict";
...
},{"../const":16,"capsid":3}],13:[function(require,module,exports){
"use strict";
...
},{"../const":16,"capsid":3}],14:[function(require,module,exports){
"use strict";
...
var TodoItem = _decorate([component('todo-item')], function (_initialize) {
...
},{"../const":16,"capsid":3}],15:[function(require,module,exports){
"use strict";
...
var TodoList = _decorate([component('todo-list')], function (_initialize) {
    ...
    d: [{
      ...
      value: function value(_ref) {
        ...
        if (this.shouldResetContents(filter, visibleTodos)) {
          ...
          visibleTodos.forEach(function (todo) {
            get('todo-item', _this.el.querySelector("[id=\"".concat(todo.id, "\"]"))).update(todo);
          });
        }
      }
    }, {
...
},{"../const":16,"capsid":3}],16:[function(require,module,exports){
"use strict";
...
function (_Filter) {
  ...
  function AllFilter() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AllFilter).apply(this, arguments));
  }
...
},{"./filter":17,"./todo":22,"./todo-collection":19,"./todo-factory":20,"./todo-repository":21}],19:[function(require,module,exports){
"use strict";
...
},{"../const":16,"./todo-collection":19}],22:[function(require,module,exports){
"use strict";
...
},{"./component":11,"./service":24}],24:[function(require,module,exports){
"use strict";
...
},{"./router":25,"./todoapp":26}],25:[function(require,module,exports){
"use strict";
...
},{"../const":16,"../domain":18,"capsid":3,"hash-route":6}],26:[function(require,module,exports){
"use strict";
...
},{"../const":16,"../domain":18,"capsid":3}]},{},[23]);
